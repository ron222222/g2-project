...
def main():
    report = {
        "program": "46_yolo_tcp_pick_lift_10cm_start_raise_safe_v2.py",
    ...
    try:
        ...
        print("=" * 78)
        print("46_yolo_tcp_pick_lift_10cm_start_raise_safe_v2.py")
        ...
        print("流程: 到绝对安全高度 -> 高位移到产品XY -> 高位旋转朝下 -> 打开夹爪 -> 下探 -> 闭合 -> 抬升10cm")
        print("=" * 78)
