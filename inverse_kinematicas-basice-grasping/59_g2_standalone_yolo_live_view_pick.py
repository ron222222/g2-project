...
# -*- coding: utf-8 -*-
"""
59_g2_standalone_yolo_live_view_pick.py
...
REPORT_FILE = "g2_standalone_yolo_live_view_pick_report.json"
ANGLE_DEBUG_IMAGE = "g2_product_angle_live_debug.jpg"
LIVE_WINDOW_NAME = "G2 YOLO Live"
LIVE_LATEST_IMAGE = "g2_yolo_live_latest.jpg"
SHOW_YOLO_WINDOW = True
SAVE_LATEST_FRAME = True
DISPLAY_SCALE = 1.0
NO_DETECTION_SLEEP_S = 0.03
WINDOW_WAIT_KEY_MS = 1
...
def main() -> None:
    report = {
        "program": "59_g2_standalone_yolo_live_view_pick.py",
    ...
    try:
        ...
        print("="*78)
        print("59_g2_standalone_yolo_live_view_pick.py")
