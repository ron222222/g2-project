...
# -*- coding: utf-8 -*-
"""
62_g2_yolo_live_angle_stable_grasp_up3cm.py
...
REPORT_FILE = "g2_yolo_live_angle_stable_grasp_up3cm_report.json"
ANGLE_DEBUG_IMAGE = "g2_product_angle_stable_up3cm_debug.jpg"
LIVE_WINDOW_NAME = "G2 YOLO Live"
LIVE_LATEST_IMAGE = "g2_yolo_angle_stable_up3cm_latest.jpg"
...
def main() -> None:
    report = {
        "program": "62_g2_yolo_live_angle_stable_grasp_up3cm.py",
        ...
        "calibration_changes": {
            ...
            "grasp_z_correction_from_61_m": GRASP_Z_CORRECTION_M,
    ...
    try:
        ...
        print("="*78)
        print("62_g2_yolo_live_angle_stable_grasp_up3cm.py")
        ...
        print(f"抓取TCP相对产品表面Z={GRASP_ABOVE_PRODUCT_M:.3f}m（相对61版提高30mm）")
        ...
        print("          -> YOLO位置+产品长轴")
        print("本程序为独立单文件；夹爪长轴使用局部Y轴；抓取点相对61版提高30mm。")
        print("="*78)
