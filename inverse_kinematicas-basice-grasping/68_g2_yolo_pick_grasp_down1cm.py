...
# -*- coding: utf-8 -*-
"""
68_g2_yolo_pick_grasp_down1cm.py
...
REPORT_FILE = "g2_yolo_pick_grasp_down1cm_report.json"
LIVE_IMAGE_FILE = "g2_yolo_grasp_down1cm_live.jpg"
ANGLE_IMAGE_FILE = "g2_yolo_grasp_down1cm_angle.jpg"
...
GRASP_ABOVE_PRODUCT_M = 0.035  # 相对66版最终抓取点下降10mm: 45mm -> 35mm
...
def main():
    report={"program":"68_g2_yolo_pick_grasp_down1cm.py",
            ...
            "grasp_height_calibration": {
                "source_program": "66_g2_yolo_pick_closed_loop_grasp_up2cm.py",
                "previous_grasp_above_product_m": 0.045,
                "new_grasp_above_product_m": 0.035,
                "z_change_m": -0.010,
                "direction": "down",
            },
    ...
    try:
        ...
        print("="*78)
        print("68_g2_yolo_pick_grasp_down1cm.py")
        ...
        print("最终抓取点相对66版向下调整=0.010m")
        print("66版偏移=0.045m, 68版偏移=0.035m")
