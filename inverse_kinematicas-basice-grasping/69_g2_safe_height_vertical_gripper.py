...
# -*- coding: utf-8 -*-
"""
69_g2_safe_height_vertical_gripper.py
...
REPORT_FILE = "g2_safe_height_vertical_gripper_report.json"
LIVE_IMAGE_FILE = "g2_safe_height_vertical_live.jpg"
ANGLE_IMAGE_FILE = "g2_safe_height_vertical_angle.jpg"
...
GRASP_ABOVE_PRODUCT_M = 0.055  # 比68版提高20mm，避免指尖接近桌面
...
def main():
    report={"program":"69_g2_safe_height_vertical_gripper.py",
    ...
    try:
        ...
        print("="*78)
        print("69_g2_safe_height_vertical_gripper.py")
        ...
        print("安全高度: 名义产品上方55mm，并受桌面Z+55mm硬下限保护")
