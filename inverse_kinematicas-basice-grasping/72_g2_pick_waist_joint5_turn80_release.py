...
# -*- coding: utf-8 -*-
"""
72_g2_pick_waist_joint5_turn80_release.py
...
REPORT_FILE = "g2_pick_waist_joint5_turn80_release_report.json"
LIVE_IMAGE_FILE = "g2_pick_waist_joint5_turn80_release_live.jpg"
ANGLE_IMAGE_FILE = "g2_pick_waist_joint5_turn80_release_angle.jpg"
...
WAIST_TURN_DEG = 80.0          # 正值为idx05正方向；反向转身改为-80.0
...
def turn_waist_keep_arms_and_release(robot,report):
    ...
    print(f"[腰部验证] idx05目标误差={waist_error_deg:.2f}deg")
...
def main():
    report={"program":"72_g2_pick_waist_joint5_turn80_release.py",
    ...
    try:
        ...
        print("="*78)
        print("72_g2_pick_waist_joint5_turn80_release.py")
        ...
        print(f"抓取后动作: 腰部idx05相对转动{WAIST_TURN_DEG:+.1f}deg，双臂关节保持，然后松开夹爪")
        print("="*78)
