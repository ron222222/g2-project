...
# -*- coding: utf-8 -*-
"""
74_g2_pick_waist_right80_segmented_release.py
...
REPORT_FILE = "g2_pick_waist_right80_segmented_release_report.json"
LIVE_IMAGE_FILE = "g2_pick_waist_right80_segmented_release_live.jpg"
ANGLE_IMAGE_FILE = "g2_pick_waist_right80_segmented_release_angle.jpg"
...
MIN_ASPECT_RATIO = 1.40
MIN_CONTOUR_AREA_RATIO = 0.025
MAX_CONTOUR_AREA_RATIO = 0.80
MAX_CONTOUR_CENTER_DISTANCE_RATIO = 0.40
CONTOUR_BORDER_MARGIN_PX = 1
...
GRASP_ABOVE_PRODUCT_M = 0.025  # 35mm会碰桌，55mm偏高，取中间45mm
...
WAIST_MAX_STEP_DEG = 10.0       # 80度拆成8个短目标，避免单次规划超时
WAIST_YAW_JOINT_INDEX = 4      # idx05_body_joint5，旋转范围约±174.5deg
WAIST_SPEED_RAD_S = 0.20
...
def main():
    report={"program":"74_g2_pick_waist_right80_segmented_release.py",
    ...
    try:
        ...
        print("="*78)
        print("74_g2_pick_waist_right80_segmented_release.py")
        ...
        print(f"边缘过滤: aspect>={MIN_ASPECT_RATIO:.2f}, area={MIN_CONTOUR_AREA_RATIO:.3f}~{MAX_CONTOUR_AREA_RATIO:.2f}, center<={MAX_CONTOUR_CENTER_DISTANCE_RATIO:.2f}, border>{CONTOUR_BORDER_MARGIN_PX}px")
        print("="*78)
