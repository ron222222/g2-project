...
REPORT_FILE = "g2_pick_fixed_anchor_orientation_report.json"
LIVE_IMAGE_FILE = "g2_pick_fixed_anchor_orientation_live.jpg"
ANGLE_IMAGE_FILE = "g2_pick_fixed_anchor_orientation_angle.jpg"
...
def main():
    report={"program":"77_g2_pick_fixed_anchor_orientation.py",
    ...
    try:
        ...
        print("="*78)
        print("77_g2_pick_fixed_anchor_orientation.py")
        ...
        print(f"固定锚点垂直姿态: 每段{MAX_YAW_PER_STAGE_DEG:.1f}deg, 累计漂移软限制={VERTICAL_FIXED_ANCHOR_SOFT_DRIFT_M:.3f}m, 硬限制={VERTICAL_FIXED_ANCHOR_HARD_DRIFT_M:.3f}m")
